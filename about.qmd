...
In addition to choice modeling, I [teach](teaching.html) multiple programming and data science courses in `r make_icon("fab fa-r-project")`, and all of my course materials are built using `r make_icon("fab fa-r-project")`, including course websites and slides. I also co-authored the [`{renderthis}`](https://jhelvy.github.io/renderthis/) package with [Garrick Aden-Buie](https://www.garrickadenbuie.com/) for rendering [`xaringan`](https://github.com/yihui/xaringan) slides into multiple different formats.
...
![John standing next to a Beijing roast duck mascot in Beijing in 2014](images/people/john_china_duck.jpg){width=80%}
...
![John swing dancing in Beijing in 2016](images/people/john_dancing.jpg){width=80% .external}
...
![John with his partner and violin after a concert at CMU in 2016](images/people/john_violin.jpg){width=60% .external}
