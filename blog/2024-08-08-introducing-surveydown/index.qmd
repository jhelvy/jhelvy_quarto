...
## Controlling the survey logic

At the very bottom of the .qmd file is a special code chunk that defines the app server. This is where you can customize and control the survey flow logic as well as where you define the database that will store the survey response data. It looks like this:
...
The `sd_config()` function is where you can define
